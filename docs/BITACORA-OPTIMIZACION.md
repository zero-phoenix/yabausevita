...
| A9 | ~~Esta build no imprime `drawn/presented/dropped`~~ **SUPERADO por medición (2-sep-2026)**: `VIDGPUVdp2LogTiming` los imprime cada 5 s desde el 18-jul y `vita3k_ctl.py` los captura por ventana. Medido: drawn=94, presented=94, dropped=0 a 34,7 FPS. La filosofía C tiene métrica; queda desbloqueada. | Ronda 0; verificación E1 |
